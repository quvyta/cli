//! The family's update notice: once qcli is open it asks crates.io, at most once a day, whether a
...
//! and no network is silence. The switch is the family's, `update-notice` in the shared
...
impl QCli {
    /// The same chat, asking at start whether a newer version is out while the family's update
    ...
    /// The question for a newer version of qcli, when the family's switch is on.
